...
class WaveClipperTwo1 extends CustomClipper<Path> {
  ...
  WaveClipperTwo1({this.reverse = false, this.flip = false});
...
class WaveClipperTwo2 extends CustomClipper<Path> {
  /// reverse the wave direction in vertical axis
  bool reverse;
  ...
  WaveClipperTwo2({this.reverse = false, this.flip = false});
